...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  MethodDeclList ml = new MethodDeclList();
    if (jj_2_1(3)) {
      ...
      jj_consume_token(RBRACE);
      {if (true) return c = new ClassDeclSimple(i, vl, ml);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CLASS:
        jj_consume_token(CLASS);
        ...
        jj_consume_token(RBRACE);
      {if (true) return c = new ClassDeclExtends(i1, i2, vl, ml);}
        break;
      default:
        jj_la1[5] = jj_gen;
        jj_consume_token(-1);
  ...
  final public Formal FormalParameterRest() throws ParseException {
  Formal f;
  ...
  final public Type IdentifierType() throws ParseException {
  Token t;
  ...
  final public Exp MinusExpression() throws ParseException {
  Exp e1, e2;
    e1 = PrimaryExpression();
  ...
  final public Exp ArrayLookup() throws ParseException {
  Exp e1, e2;
    e1 = PrimaryExpression();
    jj_consume_token(LBRACKET);
    e2 = PrimaryExpression();
  ...
  final public Exp ArrayLength() throws ParseException {
  Exp e;
    e = PrimaryExpression();
  ...
  final public Exp MessageSend() throws ParseException {
  Exp e;
  Identifier i;
  ...
  final public ExpList ExpressionList() throws ParseException {
  Exp e1, e2;
  ExpList el = new ExpList();
    e1 = Exp();
    el.addElement(e1);
  ...
  final public Exp ExpressionRest() throws ParseException {
  Exp e;
    jj_consume_token(COMMA);
    e = Exp();
    {if (true) return e;}
  ...
  final public Exp IdentifierExp() throws ParseException {
  Token t;
    t = jj_consume_token(ID);
  ...
  final public Exp ArrayAllocationExpression() throws ParseException {
  Exp e;
  ...
  final public Exp NotExpression() throws ParseException {
  Exp e;
  ...
  final public Exp AllocationExpression() throws ParseException {
  Identifier i;
    jj_consume_token(NEW);
    i = Identifier();
    jj_consume_token(LPAREN);
  ...
  final public Exp BracketExpression() throws ParseException {
  Exp e;
    jj_consume_token(LPAREN);
    e = Exp();
    jj_consume_token(RPAREN);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4,0x82,0x1000,0x82,0x1000,0x4,0x80840,0x82,0x82,0x80840,0x80840,0x24030420,0x24030420,0x8000000,0x30020,0x24000400,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x8,0x0,0x8,0x0,0x0,0xa,0x8,0x8,0xa,0xa,0x18,0x18,0x0,0x18,0x0,};
   }
